  ...
  <Html lang="es-MX">
    ...
    <Body style={body}>
      <Container style={container}>
        ...
        <Heading style={heading}>Tu cuenta ya está activa, {contactName}</Heading>

        <Text style={paragraph}>
          Un administrador de Jalector activó la cuenta de{" "}
          <strong>{companyName}</strong>. Ya puedes iniciar sesión, entrar al panel,
        ...
        <Text style={paragraph}>
          Si no reconoces esta activación o tienes dudas, responde este correo y te
          ayudamos.
        </Text>
